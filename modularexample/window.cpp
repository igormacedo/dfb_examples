...
void Window::runWindow()
{
    ...
    int px = (int)(screen_width * 0.25);
    int py = (int)(screen_height * 0.2);
    int width = screen_width - (int)(screen_width * 0.25);
    int height = screen_height - (int)(screen_height * 0.2);

    canvas = new Canvas(this->dfb, this->surface);
    canvas->initiateCanvas(px, py, height, width);
